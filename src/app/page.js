...
export default function Home() {
  ...
  return (
    <main className="bg-neutral-100 min-h-screen flex items-center justify-center text-black">
      <div className="w-full max-w-7xl h-[90vh] bg-white rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden border border-neutral-200">
        {/* Left: Image Uploader */}
        <div className="md:w-1/2 w-full flex flex-col items-center justify-center p-12 pt-16 bg-white border-r border-neutral-200 text-black">
        ...
        {/* Right: Feedback Area */}
        <div className="md:w-1/2 w-full flex flex-col items-start justify-start md:justify-center p-8 bg-neutral-50 text-black relative overflow-y-auto">
          <div className="w-full pt-240 pb-16">
            {loading && (
